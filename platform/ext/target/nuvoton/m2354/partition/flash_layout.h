...
#define FLASH_AREA_BL2_SIZE        (0x15000) /* 84 KB */
...
#define FLASH_AREA_0_ID            (1)
#define FLASH_AREA_0_OFFSET        (FLASH_AREA_BL2_OFFSET + FLASH_AREA_BL2_SIZE + 0x10000 - 0x5000)
...
#define TFM_OTP_NV_COUNTERS_AREA_SIZE   (2048)
#define TFM_OTP_NV_COUNTERS_AREA_ADDR   (0x1F000) 
#define TFM_OTP_NV_COUNTERS_SECTOR_SIZE (0x800)
